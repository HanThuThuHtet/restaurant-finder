...
const Lgoin = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center mt-[10%] gap-10'>
        <Image src='/tasty-bites.png' alt='tasty-bites' width={200} height={200} />
        <div className='px-6 sm:px-0 max-w-sm'>
            <button type="button" 
                    onClick={() => signIn()}
                    className="text-white w-full bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 
                    font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-between dark:focus:ring-[#4285F4]/55 mr-2 mb-2"><svg className="mr-2 -ml-1 w-4 h-4" 
                    aria-hidden="true" 
                    focusable="false" 
                    data-prefix="fab" 
